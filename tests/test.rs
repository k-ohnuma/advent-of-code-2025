...
fn test8_1() {
    ...
    let output = include_str!("../input/day8/out-1.txt");
    #[allow(deprecated)]
    let mut cmd = Command::cargo_bin("8-1").unwrap();
    cmd.write_stdin(input).assert().success().stdout(output);
}
#[test]
fn test8_2() {
    let input = include_str!("../input/day8/input.txt");
    let output = include_str!("../input/day8/out-2.txt");
    #[allow(deprecated)]
    let mut cmd = Command::cargo_bin("8-2").unwrap();
    cmd.write_stdin(input).assert().success().stdout(output);
}
#[test]
fn test9_1() {
    let input = include_str!("../input/day9/input.txt");
    let output = include_str!("../input/day9/out-1.txt");
    #[allow(deprecated)]
    let mut cmd = Command::cargo_bin("9-1").unwrap();
    cmd.write_stdin(input).assert().success().stdout(output);
}
#[test]
fn test9_2() {
    let input = include_str!("../input/day9/input.txt");
    let output = include_str!("../input/day9/out-2.txt");
    #[allow(deprecated)]
    let mut cmd = Command::cargo_bin("9-2").unwrap();
    cmd.write_stdin(input).assert().success().stdout(output);
}
#[test]
fn test10_1() {
    let input = include_str!("../input/day10/input.txt");
    let output = include_str!("../input/day10/out-1.txt");
    #[allow(deprecated)]
    let mut cmd = Command::cargo_bin("10-1").unwrap();
    cmd.write_stdin(input).assert().success().stdout(output);
}
#[test]
fn test10_2() {
    let input = include_str!("../input/day10/input.txt");
    let output = include_str!("../input/day10/out-2.txt");
    #[allow(deprecated)]
    let mut cmd = Command::cargo_bin("10-2").unwrap();
    cmd.write_stdin(input).assert().success().stdout(output);
}
#[test]
fn test11_1() {
    let input = include_str!("../input/day11/input.txt");
    let output = include_str!("../input/day11/out-1.txt");
    #[allow(deprecated)]
    let mut cmd = Command::cargo_bin("11-1").unwrap();
    cmd.write_stdin(input).assert().success().stdout(output);
}
#[test]
fn test11_2() {
    let input = include_str!("../input/day11/input.txt");
    let output = include_str!("../input/day11/out-2.txt");
    #[allow(deprecated)]
    let mut cmd = Command::cargo_bin("11-2").unwrap();
    cmd.write_stdin(input).assert().success().stdout(output);
}
#[test]
fn test12_1() {
    let input = include_str!("../input/day12/input.txt");
    let output = include_str!("../input/day12/out-1.txt");
    #[allow(deprecated)]
    let mut cmd = Command::cargo_bin("12-1").unwrap();
    cmd.write_stdin(input).assert().success().stdout(output);
}
